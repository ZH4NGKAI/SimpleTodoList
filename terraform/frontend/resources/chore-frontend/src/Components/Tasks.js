              ...
              <ListItem key={task.id}>
                <Checkbox
                  onChange={async () => {
                    ...
                    const res = await fetch("http://54.88.155.50:5000/checkTask", {
                      method: "PUT",
                      headers: {
                ...
                <IconButton
                  ...
                  onClick={async () => {
                    // Delete task
                    const res = await fetch("http://54.88.155.50:5000/deleteTask", {
                      method: "DELETE",
                      headers: {
                        "Content-Type": "application/json",
                      },
        ...
        <DialogActions>
          ...
          <Button
            onClick={async () => {
              ...
              const res = await fetch("http://54.88.155.50:5000/editTask", {
                method: "PUT",
                headers: {
                  "Content-Type": "application/json",
                },
